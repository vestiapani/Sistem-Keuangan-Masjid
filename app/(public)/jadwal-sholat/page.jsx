...
import { MapPin, Pencil, Compass, Calendar, Settings } from "lucide-react";
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10 space-y-6 sm:space-y-8">
      <div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="flex items-center space-x-2 text-sm border border-slate-200 bg-white rounded-lg px-3 py-2 cursor-pointer hover:bg-slate-50 w-fit">
        ...
        {PRAYER_DATA.times.map((prayer) => (
          ...
          >
            {prayer.active && prayer.countdown && (
              <span className="text-[10px] font-bold text-emerald-200 mb-1">
                {prayer.countdown}
              </span>
            )}
            <span
